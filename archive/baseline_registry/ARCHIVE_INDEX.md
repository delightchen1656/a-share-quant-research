...
| `STRATEGY_BASELINES.md` | 五个正式基准的统一编号和关键结果 |
| `BASELINE_NAME_MAP.json` | 新旧编号、中文名和技术路径的机器可读映射 |
| `BASELINE_LOCAL_COMPARISON.md` | 五个基准统一口径本地回测集合表 |
| `BASELINE_LOCAL_COMPARISON.csv` | 五个基准集合表的机器可读数据 |
| `BASELINE_LOCAL_COMPARISON_DETAILED.md` | 五个基准三种回测口径的完整集合表 |
| `../../supermind_baselines/` | 五个基准按规范编号命名的SuperMind平台交付代码 |
...
3. 所有对外讨论使用新编号：基准1-1、1-2、1-3、2-1、2-2。
